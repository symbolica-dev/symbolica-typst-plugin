...
- [`expression-grid.typ`](typst/examples/expression-grid.typ), inspired by
...
- [`lotka-volterra.typ`](typst/examples/lotka-volterra.typ), inspired by
...
- [`phase-portrait.typ`](typst/examples/phase-portrait.typ), inspired by
